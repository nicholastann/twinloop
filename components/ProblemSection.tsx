        ...
        <ScrollFadeUp yOffset={30} duration={0.8} delay={0.2}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 max-w-7xl mx-auto divide-y md:divide-y-0 md:divide-x divide-[#236a7c]/20 border-t border-b border-[#236a7c]/20 md:border-none">
            {PROBLEMS.map((problem, index) => (
              <div
                key={index}
                className="group relative p-4 md:p-12 flex flex-col items-center justify-center text-center transition-all duration-300 hover:bg-[#e0f7fa]/20 cursor-default"
              >
                {/* Icon Wrapper - Lifts on hover */}
                <div className="mb-3 md:mb-8 transform transition-transform duration-300 group-hover:-translate-y-2">
                  <div className="inline-flex items-center justify-center w-14 h-14 md:w-24 md:h-24 rounded-full bg-gradient-to-br from-[#def2f8] to-[#ffffff] border border-white shadow-[0_10px_30px_-5px_rgba(35,106,124,0.25)] text-[#236a7c] text-2xl md:text-4xl relative overflow-hidden group-hover:shadow-[0_15px_30px_-5px_rgba(35,106,124,0.4)] group-hover:border-[#236a7c]/20 transition-all duration-300">
                ...
                <p className="text-[#334155] text-base md:text-3xl font-black leading-tight max-w-xs mx-auto tracking-tight transition-colors duration-300 group-hover:text-[#0f172a]">
                  {problem.text}
                </p>
