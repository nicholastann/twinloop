  ...
  return (
    <section className="container mx-auto px-6 lg:px-8 relative">
      <div className="flex flex-col gap-8">
        ...
        <div className="hidden md:flex flex-nowrap overflow-x-auto gap-4 md:gap-6 pb-4 md:pb-0 px-4 md:px-0 scrollbar-hide md:justify-center">
          {steps.map((step, index) => (
            <button
              key={index}
              onClick={() => setActiveStep(index)}
              className={`relative px-10 py-6 rounded-full text-base font-bold uppercase tracking-widest transition-all duration-500 overflow-hidden group ${activeStep === index
        ...
        <div className="relative">
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-24 items-center max-w-7xl mx-auto px-8 md:px-0">
            ...
            <div className="text-center lg:text-left order-1 lg:order-1 py-8">
              <AnimatePresence mode="wait">
                ...
                >
                  <div className="flex items-center gap-6 mb-8 group-hover:scale-[1.02] transition-transform duration-500 justify-center lg:justify-start">
                    <div className={`inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-gradient-to-br ${steps[activeStep].theme} text-white text-3xl shadow-2xl shrink-0`}>
                      {steps[activeStep].icon}
                    </div>
                    <h3 className="text-3xl md:text-6xl font-black text-[#0f172a] tracking-tight leading-tight text-left">
